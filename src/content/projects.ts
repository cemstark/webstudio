...
export const projects: readonly Project[] = [
  { slug: "vela-windsurfing", name: "Vela Windsurfing", year: 2026, status: "live", statusLabel: "Yayında", category: "Web Tasarım & Geliştirme", description: "Vela Windsurfing için tasarlanıp yayına alınan web sitesi.", featured: true, url: "https://velawindsurfing.com", image: { src: "/images/projects/vela-windsurfing/vela-windsurfing-cover.webp", alt: "Vela Windsurfing web sitesinin ana sayfası", width: 2503, height: 1408, position: "48% center" } },
  { slug: "aysaworks", name: "AysaWorks", status: "archive", statusLabel: "Arşiv", category: "Web Tasarım", description: "İç mimarlık projelerini sergileyen web sitesi ve portfolyo deneyimi.", featured: true, image: { src: "/images/projects/aysaworks/aysaworks-cover.webp", alt: "AysaWorks iç mimarlık projeleri sayfası", width: 2498, height: 1395, position: "50% center" } },
  { slug: "bluekim", name: "BlueKim", status: "archive", statusLabel: "Arşiv", category: "Web Tasarım", description: "BlueKim ve BlueMet markalarını aynı kurumsal deneyimde buluşturan web sitesi.", featured: true, image: { src: "/images/projects/bluekim/bluekim-cover.webp", alt: "BlueKim ve BlueMet kurumsal web sitesi ana sayfası", width: 2495, height: 1371, position: "50% center" } },
  { slug: "drnekinoto-servis", name: "DRNEKİN OTO", status: "archive", statusLabel: "Arşiv", category: "Web Geliştirme", description: "İzmit ve Kocaeli odaklı otomotiv servis web sitesi.", featured: false, image: { src: "/images/projects/drnekinoto-servis/drnekinoto-servis-cover.webp", alt: "DRNEKİN OTO otomotiv servis web sitesi ana sayfası", width: 2496, height: 1396, position: "52% center" } },
  { slug: "cemwebstudio", name: "cemwebstudio", year: 2026, status: "live", statusLabel: "Yayında", category: "Marka & Web", description: "Web tasarım, SEO, mobil uygulama ve e-ticaret hizmetlerini sunan stüdyo portfolyosu.", featured: false, image: { src: "/images/projects/cemwebstudio/cemwebstudio-cover.webp", alt: "cemwebstudio ana sayfasındaki robot destekli dijital deneyim", width: 2460, height: 1402, position: "50% center" } },
